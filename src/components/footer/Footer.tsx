...
const Footer = () => {
  return (
    <footer className='w-full bg-[#2d394b] bg-opacity-90 font-accent'>
      <div
        className="abosolute inset-0 -z-10 bg-[url('/backgground-image.png')] bg-cover bg-center bg-no-repeat bg-fixed"
        aria-hidden="true" />
      <div className='container mx-auto px-4 sm:px-8 lg:px-16 xl:px-20 py-20 grid grid-cols-1 md:grid-cols-2 gap-8 relative'>
        <div className='flex flex-col gap-8'>
          ...
          <div className='pt-6'>
            <Link href={footerData.links.privacyPolicy} className='text-white hover:underline'>
              Privacy Policy
            </Link>
